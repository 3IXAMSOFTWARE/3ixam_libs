...
#define OSL_VERSION_MINOR 12
#define OSL_VERSION_PATCH 6
#define OSL_VERSION_TWEAK 2
...
#define OSL_LIBRARY_VERSION_MINOR 12
#define OSL_LIBRARY_VERSION_PATCH 6
#define OSL_LIBRARY_VERSION_TWEAK 2
...
namespace OSL_v1_12 { }
namespace OSL = OSL_v1_12;

// Macros to use in each file to enter and exit the right name spaces.
#define OSL_NAMESPACE OSL_v1_12
#define OSL_NAMESPACE_STRING "OSL_v1_12"
#define OSL_NAMESPACE_ENTER namespace OSL_v1_12 {
#define OSL_NAMESPACE_EXIT }


// Which CPP standard (11, 14, etc.) was this copy of OIIO *built* with?
#define OSL_BUILD_CPP 14

// DEPRECATED(2.1): old macros separately giving compatibility.
#define OSL_BUILD_CPP11 (14 >= 11)
#define OSL_BUILD_CPP14 (14 >= 14)
#define OSL_BUILD_CPP17 (14 >= 17)
#define OSL_BUILD_CPP20 (14 >= 20)

#define OSL_SHADER_INSTALL_DIR "/Users/brecht/dev/build_darwin/deps/Release/osl/share/OSL/shaders"
